...
import { USER_PROGRAMS } from "../../public/constants";
      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        >
          <CarouselContent className="-ml-2 md:-ml-4">
            {USER_PROGRAMS.slice(0, 5).map((program) => (
              <CarouselItem
                key={program.id}
                className="pl-2 md:pl-4 basis-[85%] sm:basis-1/2 md:basis-1/3"
              >
                <Card className="overflow-hidden rounded-2xl bg-card/90 backdrop-blur-sm hover:border-primary/50 border border-border transition-all">
